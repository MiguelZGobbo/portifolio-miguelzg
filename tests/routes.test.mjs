...
const { homePath, pageUrl, routeConfig } = await import('../src/lib/routes.ts');
...
test('composes absolute page URLs from a site origin and a normalized path', () => {
  assert.equal(
    pageUrl('https://miguelzgobbo.github.io', '/portifolio-miguelzg/en/'),
    'https://miguelzgobbo.github.io/portifolio-miguelzg/en/',
  );
  assert.equal(
