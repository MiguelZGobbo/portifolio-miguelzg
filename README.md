...
| Script | Uso |
| --- | --- |
| npm test | Gera as seis páginas estáticas e executa 86 testes de modelo, páginas construídas, navegação, SEO e arquitetura. |
...
A Fase 7 de localização por rotas e SEO está consolidada em [docs/phases/phase-7-consolidation.md](docs/phases/phase-7-consolidation.md). O build atual publica seis páginas estáticas com identidade de idioma e metadados próprios, e a regressão final reúne 86 testes além da auditoria funcional e visual em navegador. O polimento de ritmo visual, tipografia, espaçamento, decoração e decisões finais de motion pertence à Fase 8, sem alterar hierarquia, rotas, metadados ou comportamento de acessibilidade.
